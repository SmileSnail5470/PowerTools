...
if sys.platform != "win32" or sys.getwindowsversion().build < 22000:
    from app.ui.library.qframelesswindow import FramelessWindow
else:
    ...
    from app.ui.library.qframelesswindow import AcrylicWindow as Window
    from app.ui.library.qframelesswindow.titlebar.title_bar_buttons import TitleBarButtonState
